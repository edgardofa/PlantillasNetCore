...
namespace WebApi_ComprasStock.Migrations
{
    ...
    [Migration("20210907152718_corregirCondIVAActivo")]
    partial class corregirCondIVAActivo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi_ComprasStock.Entidades.UnidadDeMedida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApi_ComprasStock.Entidades.DatosProveedores", b =>
                {
                    b.HasOne("WebApi_ComprasStock.Entidades.Diccionario_CIVA", "Diccionario_CIVA")
                        .WithMany()
                        .HasForeignKey("CIVAId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Diccionario_CIVA");
                });
            ...
            modelBuilder.Entity("WebApi_ComprasStock.Entidades.Producto", b =>
                {
                    ...
                    b.HasOne("WebApi_ComprasStock.Entidades.UnidadDeMedida", "UnidadDeMedida")
                        .WithMany()
